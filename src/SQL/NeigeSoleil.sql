    ...
    CREATE TABLE IF NOT EXISTS EXCLUSIONS (
        ...
        CONSTRAINT FK_EXCLUSIONS_CONTRAT FOREIGN KEY (ID_CONTRAT) REFERENCES CONTRAT_DE_MANDAT_LOCATIF(ID_CONTRAT)
    ) ENGINE=InnoDB;
    ...
    CREATE TABLE IF NOT EXISTS CONTRAT_DE_RESERVATION (
        ...
        ETAT ENUM('Confirmé', 'Annulé') NOT NULL, 
    ...
    CREATE TABLE IF NOT EXISTS SEMAINES_LOUEES (
        ...
        CONSTRAINT FK_SEMAINES_CONTRAT_DE_RESERVATION FOREIGN KEY (NUMERO_CONTRAT) REFERENCES CONTRAT_DE_RESERVATION(NUMERO_CONTRAT)
    ) ENGINE=InnoDB;
...
VALUES
('B001', 101, 1, 3, '10 rue de la Paix', 75001, LOAD_FILE('C:/wamp64/tmp/appart.jpg'), LOAD_FILE('C:/wamp64/tmp/appart.jpg'), LOAD_FILE('C:/wamp64/tmp/appart.jpg'), 'F2', 'Sud', 45, 5, 2, 500),
